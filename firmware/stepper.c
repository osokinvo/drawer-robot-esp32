// Этот файл содержит функции, которые управляют шаговыми двигателями, такие как функции для управления скоростью, направлением и т. д.
...
static void motor_control_step(motor_control_t* motor) {
